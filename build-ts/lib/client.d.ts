...
export default class CommonClient extends EventEmitter {
     ...
     * @return {CommonClient}
     */
    constructor(webSocketFactory: ICommonWebSocketFactory, address?: string | (() => Promise<string>), options?: IWSClientAdditionalOptions & NodeWebSocket.ClientOptions, generate_request_id?: (method: string, params: object | Array<any>) => number);
    /**
